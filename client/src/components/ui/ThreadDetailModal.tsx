...
export default function ThreadDetailModal({
  ...
  const handleToggleReplyLike = async (replyId: number) => {
    try {
      ...
      if (currentReply && thread) {
        dispatch(toggleReplyLike({ replyId, currentIsLiked: currentReply.is_liked }));
  ...
  return (
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50">
      <div className="bg-white w-[90vw] h-[90vh] max-w-5xl rounded-xl overflow-hidden flex relative">
        ...
        <div className="w-1/2 flex flex-col bg-white">
          ...
          <div className="p-4 flex items-center gap-2 border-b">
            ...
            />
            <div>
              <p className="font-bold">{profileUser.full_name}</p>
